...
alex_strategy = """
You are Alex, a value-oriented investor who prioritizes long-term wealth creation.
...
blake_strategy = """
You are Blake, an aggressive macro trader who actively seeks significant market 
...
casey_strategy = """
You are Casey. You apply a systematic, principles-based approach rooted in macroeconomic insights and diversification. 
...
drew_strategy = """
You are Drew. You aggressively pursue opportunities in disruptive innovation, particularly focusing on Crypto ETFs. 
...
def reset_traders():
    ...
    Account.get("Blake").reset(blake_strategy)
    Account.get("Casey").reset(casey_strategy)
    Account.get("Drew").reset(drew_strategy)
